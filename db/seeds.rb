...
user2 = User.create!(email: "admin@example.com", password: "senha123", role: "admin")

# Criar produtos
product1 = Product.create!(name: "Camiseta Branca", description: "Camiseta básica de algodão", price: 29.99, category: "Roupas")
product2 = Product.create!(name: "Calça Jeans", description: "Calça jeans azul", price: 89.99, category: "Roupas")
product3 = Product.create!(name: "Tênis Esportivo", description: "Tênis para corrida", price: 149.99, category: "Calçados")
